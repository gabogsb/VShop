...
public class AppDbContext : DbContext
{
  ...
  protected override void OnModelCreating(ModelBuilder mb)
  {
    ...
    mb.Entity<Category>().Property(c => c.Name).HasMaxLength(150).IsRequired();


    //Product
    mb.Entity<Product>().Property(c => c.Name).HasMaxLength(150).IsRequired();

    mb.Entity<Product>().Property(c => c.Description).HasMaxLength(250).IsRequired();
